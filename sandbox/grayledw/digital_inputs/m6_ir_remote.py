...
# TODO: 6. Implement the IR handler callbacks handlers.
    ch1.on_red_up = lambda button_state : handle_red_up_1()
    ch1.on_blue_up = lambda button_state : handle_blue_up_1()
    ch1.on_blue_down = lambda button_state: handle_blue_down_1()
    ch1.on_red_down = lambda button_state: handle_red_down_1()
    ch2.on_red_up = lambda  button_state: handle_arm_up_button(button_state, robot)
    ch2.on_blue_up = lambda button_state: handle_arm_up_button(button_state, robot)
    ch2.on_blue_down = lambda button_state: handle_arm_down_button(button_state, robot)
    ch2.on_red_down = lambda  button_state: handle_arm_down_button(button_state, robot)
...
def handle_red_down_1():
    move_left_tread()

def handle_blue_up_1():
    move_right_tread()

def handle_blue_down_1():
    move_right_tread()
