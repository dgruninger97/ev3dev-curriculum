...
def main():
    ...
    # TO DO: 4: After running the code set the default white and black levels to a better initial guess.
    ...
    while True:
        ...
        if command_to_run == 'w':
            ...
            # TO DO: 2. Read the reflected_light_intensity property of the color sensor and set white_level to that value
            ...
            # TO DO: 3. Read the reflected_light_intensity property of the color sensor and set black_level
...
def follow_the_line(robot, white_level, black_level):
    ...
    # TO DO: 5. Use the calibrate
    # ted values for white and black to calculate a light threshold to determine if your robot
