...
# TO DO: 2. Get a yardstick or tape measure to do some testing with /examples/motors/drive_input_speed.py
...
#
# TO DO: 3. Copy the content of the /examples/motors/drive_input_speed.py program and place it below these comments.
...
def main():
    ...
    print("  Timed drive")
    print("--------------------------------------------")
    ev3.Sound.speak("Timed drive").wait()
