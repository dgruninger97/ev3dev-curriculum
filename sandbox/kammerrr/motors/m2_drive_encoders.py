...
def main():
    ...
    while time_s != 0:
        ...
        left_motor.run_to_rel_pos(position_sp=dis_ang, speed_sp=sp_ang)
...
# ----------------------------------------------------------------------
main()
# TO DO: 3. Add a beep after the drive motors stop (see code below).  Test your code to hear the beep AFTER movement.
#   ev3.Sound.beep().wait()

# TO DO: 4. Instead of using the run_forever, time.sleep, stop pattern switch to using the run_to_rel_pos command.
...
# TO DO: 5. Make sure the beep happens AFTER the motors stop.  Use the wait_while command to block code execution.

# TO DO: 6. Formally test your work. When you think you have the problem complete run these tests:
...
# TO DO: 7. Call over a TA or instructor to sign your team's checkoff sheet and do a code review.
#
