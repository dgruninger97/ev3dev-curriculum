...
def main():
    ...
    while True:
        ...
        robot.polygon(speed_deg_per_second, sides, edge_length_in)
        # TO DO: 2. Individually implement the code here to use your drive_inches and turn_degrees library methods to
