...
def main():
    ...
    my_name = input("Name of sub.: ")  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = input("Team name(pub to): ")# Used to set the topic that you will *publish to*
