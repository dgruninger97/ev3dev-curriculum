...
# TO DO: 2. Have someone on your team run this program as is on the EV3 and make sure everyone understands the code.
...
def main():
    ...
    while True:
        ...
        # print("TO DO: 3 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_calibration(arm_motor, touch_sensor)
        elif command_to_run == 'u':
            print("Move the arm to the up position")
        # print("TO DO: 4 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_up(arm_motor, touch_sensor)
        elif command_to_run == 'd':
            print("Move the arm to the down position")
        # print("TO DO: 5 is to delete this print statement, uncomment the line below, and implement that function.")
            arm_down(arm_motor)
...
def arm_calibration(arm_motor, touch_sensor):
    ...
    """
    # TO DO: 3. Implement the arm calibration movement by fixing the code below (it has many bugs).  It should do this:
...
def arm_up(arm_motor, touch_sensor):
    ...
    Type hints:
      ...
      :type touch_sensor: ev3.TouchSensor
    """
    # TO DO: 4. Implement the arm up movement by fixing the code below
    # Command the arm_motor to run forever in the positive direction at max speed.
...
def arm_down(arm_motor):
    ...
    Type hints:
      :type arm_motor: ev3.MediumMotor
    """
    # TO DO: 5. Implement the arm up movement by fixing the code below
