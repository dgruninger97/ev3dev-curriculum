...
Authors: David Fisher and Ryan Kammerer.
...
def main():
    ...
    # TO DO: 3. Create a remote control object for channel 1. Add lambda callbacks for:
    ...
    while dc.running:
        # TO DO: 4. Call the .process() method on your channel 1 RemoveControl object, then review and run your code.
        #   Review the handle functions below to see how they draw to the screen.  They are already finished.
        rc1.process()
        # TO DO: 6. Call the .process() method on your channel 2 - 4 RemoveControl objects and demo your code.
        #   Review the handle functions below to see how they draw to the screen.  They are already finished.
        rc2.process()
        rc3.process()
        rc4.process()
