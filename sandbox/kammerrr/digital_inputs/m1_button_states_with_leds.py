...
Much like we did in dgruninger97 of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    while True:
        # TO DO: 3. Implement the left, right, and up buttons as follows:
